...
class StoreRoleRequest extends FormRequest
{
    ...
    /**
     * The URI that roles should be redirected to if validation fails.
     * this doesn't work until you comment the failedValidation method
     * @var string
     */
    // protected $redirect = '/api/roles';

    /**
     * The named route that roles should be redirected to if validation fails.
     * @var string
     */
    ...
    {
        // Example: Authorize only if the user has permission to create roles
        // return auth()->user()?->can('create', Role::class) ?? true;
