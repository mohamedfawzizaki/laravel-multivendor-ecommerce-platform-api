...
use App\Services\Warehouses\WarehouseBinService;
...
{
    /**
     * Constructor to inject the WarehouseBinService dependency.
     *
     * @param WarehouseBinService $warehouseBinService The service responsible for warehouse-related operations.
     */
    public function __construct(protected WarehouseBinService $warehouseBinService) {}
    ...
    public function index(PaginateRequest $request): JsonResponse
    {
        try {
            if (Auth::user()->role == 'admin') {
                ...
                $warehouses = $paginate
                    ? $this->warehouseBinService->getAll(
    ...
    public function show(ValidateColumnAndConditionRequest $request, string $id): JsonResponse
    {
        try {
            ...
            $warehouse = $this->warehouseBinService->getById($id, $columns);
    ...
    public function store(StoreWarehouseRequest $request): JsonResponse
    {
        try {
            ...
            $warehouse = $this->warehouseBinService->create($data);
    ...
    {
        try {
            $warehouse = $this->warehouseBinService->getById($id);
            ...
            if (Auth::user()->role == 'admin') {
                $warehouse = $this->warehouseBinService->update($id, $data);
            } else {
    ...
    public function delete(ValidateColumnAndConditionRequest $request, string $id)
    {
        try {
            ...
            $deleted = $this->warehouseBinService->delete($id, true);
