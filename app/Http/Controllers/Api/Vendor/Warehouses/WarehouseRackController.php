...
use App\Services\Warehouses\WarehouseRackService;
...
{
    /**
     * Constructor to inject the WarehouseRackService dependency.
     *
     * @param WarehouseRackService $warehouseRackService The service responsible for warehouse-related operations.
     */
    public function __construct(protected WarehouseRackService $warehouseRackService) {}
    ...
    public function index(PaginateRequest $request): JsonResponse
    {
        try {
            if (Auth::user()->role == 'admin') {
                ...
                $warehouses = $paginate
                    ? $this->warehouseRackService->getAll(
    ...
    public function show(ValidateColumnAndConditionRequest $request, string $id): JsonResponse
    {
        try {
            ...
            $warehouse = $this->warehouseRackService->getById($id, $columns);
    ...
    public function store(StoreWarehouseRequest $request): JsonResponse
    {
        try {
            ...
            $warehouse = $this->warehouseRackService->create($data);
    ...
    {
        try {
            $warehouse = $this->warehouseRackService->getById($id);
            ...
            if (Auth::user()->role == 'admin') {
                $warehouse = $this->warehouseRackService->update($id, $data);
            } else {
    ...
    public function delete(ValidateColumnAndConditionRequest $request, string $id)
    {
        try {
            ...
            $deleted = $this->warehouseRackService->delete($id, true);
