...
use App\Services\Warehouses\WarehouseShelfService;
...
{
    /**
     * Constructor to inject the WarehouseShelfService dependency.
     *
     * @param WarehouseShelfService $warehouseShelfService The service responsible for warehouse-related operations.
     */
    public function __construct(protected WarehouseShelfService $warehouseShelfService) {}
    ...
    public function index(PaginateRequest $request): JsonResponse
    {
        try {
            if (Auth::user()->role == 'admin') {
                ...
                $warehouses = $paginate
                    ? $this->warehouseShelfService->getAll(
    ...
    public function show(ValidateColumnAndConditionRequest $request, string $id): JsonResponse
    {
        try {
            ...
            $warehouse = $this->warehouseShelfService->getById($id, $columns);
    ...
    public function store(StoreWarehouseRequest $request): JsonResponse
    {
        try {
            ...
            $warehouse = $this->warehouseShelfService->create($data);
    ...
    {
        try {
            $warehouse = $this->warehouseShelfService->getById($id);
            ...
            if (Auth::user()->role == 'admin') {
                $warehouse = $this->warehouseShelfService->update($id, $data);
            } else {
    ...
    public function delete(ValidateColumnAndConditionRequest $request, string $id)
    {
        try {
            ...
            $deleted = $this->warehouseShelfService->delete($id, true);
